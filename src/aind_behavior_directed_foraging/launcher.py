...
from .rig import AindBehaviorDirectedForagingRig
from .task_logic import AindBehaviorDirectedForagingTaskLogic
...
def make_launcher(settings: LauncherCliArgs) -> Launcher:
    ...
    picker = DefaultBehaviorPicker[AindBehaviorDirectedForagingRig, AindBehaviorSessionModel, AindBehaviorDirectedForagingTaskLogic](
