...
class DataMapperCli(pydantic_settings.BaseSettings, cli_kebab_case=True):
    ...
    suffix: Optional[str] = pydantic.Field(default="directed-foraging", description="Suffix to append to output filenames.")
    ...
    def cli_cmd(self):
        ...
        rig = model_from_json_file(abs_schemas_path / "rig_input.json", AindBehaviorDirectedForagingRig)
        task_logic = model_from_json_file(abs_schemas_path / "tasklogic_input.json", AindBehaviorDirectedForagingTaskLogic)
