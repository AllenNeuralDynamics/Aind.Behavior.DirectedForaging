...
class AindRigDataMapper(ads.AindDataSchemaRigDataMapper):
    ...
    @classmethod
    def build_runner(cls) -> Callable[[Launcher[AindBehaviorDirectedForagingRig, Any, Any]], "AindRigDataMapper"]:
        def _new(
            launcher: Launcher[AindBehaviorDirectedForagingRig, Any, Any],
        ) -> "AindRigDataMapper":
    ...
    @classmethod
    def _map(cls, rig: AindBehaviorDirectedForagingRig) -> instrument.Instrument:
