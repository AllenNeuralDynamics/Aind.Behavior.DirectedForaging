...
class AindSessionDataMapper(ads.AindDataSchemaSessionDataMapper):
    ...
    def __init__(
        ...
        rig_model: AindBehaviorDirectedForagingRig,
        task_logic_model: AindBehaviorDirectedForagingTaskLogic,
    ...
    def build_runner(
        ...
        [Launcher[AindBehaviorDirectedForagingRig, AindBehaviorSessionModel, AindBehaviorDirectedForagingTaskLogic]], "AindSessionDataMapper"
    ]:
        def _new(
            launcher: Launcher[AindBehaviorDirectedForagingRig, AindBehaviorSessionModel, AindBehaviorDirectedForagingTaskLogic],
