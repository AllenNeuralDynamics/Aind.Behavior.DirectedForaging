...
import aind_behavior_directed_foraging
import aind_behavior_directed_foraging.data_contract as contract
import aind_behavior_directed_foraging.rig
import aind_behavior_directed_foraging.task_logic

SOURCE_ROOT = "https://github.com/AllenNeuralDynamics/Aind.Behavior.DirectedForaging/tree/main/src/"

# -- Project information -----------------------------------------------------
# https://www.sphinx-doc.org/en/master/usage/configuration.html#project-information

project = " directed-foraging "
copyright = "2025, Allen Institute for Neural Dynamics"
author = " RoboDoig "
release = aind_behavior_directed_foraging.__semver__
...
export_model_diagram(aind_behavior_directed_foraging.task_logic.AindBehaviorDirectedForagingTaskLogic, _static_path)
