...
from aind_behavior_directed_foraging.data_mappers import AindRigDataMapper, AindSessionDataMapper
...
class TestAindSessionDataMapper(unittest.TestCase):
    ...
    @patch("aind_behavior_directed_foraging.data_mappers.AindSessionDataMapper._map")
...
class TestAindRigDataMapper(unittest.TestCase):
    ...
    @patch("aind_behavior_directed_foraging.data_mappers.AindRigDataMapper._map")
    def test_mock_map(self, mock_map):
        mock_map.return_value = MagicMock()
        result = self.mapper.map()
        self.assertIsNotNone(result)
